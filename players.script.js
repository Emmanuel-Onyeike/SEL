document.addEventListener('DOMContentLoaded', () => {
    ...
    // Centered Modal Logic (Strictly in center of page per instructions)
    ...
    if (addPlayerBtn) {
        addPlayerBtn.addEventListener('click', () => {
            showModal("No data yet. You can initialize player records once club rosters are unlocked by the league administrator.");
        });
    }

    if (emptyStateAddBtn) {
        emptyStateAddBtn.addEventListener('click', () => {
            showModal("No data yet. Player profile creation is currently restricted until the initial CSV or manual squad list is saved.");
        });
    }
