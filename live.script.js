document.addEventListener('DOMContentLoaded', () => {
    ...
    const broadcastMatchBtn = document.getElementById('broadcastMatchBtn');
    const emptyStateBroadcastBtn = document.getElementById('emptyStateBroadcastBtn');
    ...
    if (broadcastMatchBtn) {
        broadcastMatchBtn.addEventListener('click', () => {
            showModal("No data yet. Live broadcasting controls are locked until fixtures and team rosters are configured.");
        });
    }

    if (emptyStateBroadcastBtn) {
        emptyStateBroadcastBtn.addEventListener('click', () => {
            showModal("No data yet. Real-time match commentary streams will activate once fixtures are underway.");
        });
    }
